...
c("Modularity","Paradigm", "Syntax") %>%
  write_to_render_post(path_to_main_dir_1L_chr = "~/Documents/WIP/ready4/Code/Brochure/HTML/ready4web/content/en/docs/Framework/Implementation",
                       consent_1L_chr = "Y",
                       is_rmd_1L_lgl = F)
...
write_to_render_post("Finding-Modules",
                     path_to_main_dir_1L_chr = "~/Documents/WIP/ready4/Code/Brochure/HTML/ready4web/content/en/docs/Model",
                     consent_1L_chr = "Y",
                     is_rmd_1L_lgl = F)
