...
{{% pageinfo %}}
This below section embeds a HTML version of an R Markdown program. The following alternative options may provide improved viewing experience, more contextual information and access to more useful code formats:
...
xfun::file_string('https://raw.githubusercontent.com/ready4-dev/aqol6dmap_fakes/main/Fake_Data_Generator.html')
```
````
