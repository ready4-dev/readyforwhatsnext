...
Currently available (as at  `r format(Sys.Date(),"%d-%b-%Y")`) releases of [module libraries](/docs/software/libraries/types/module/) for [modelling places](/docs/model/using-modules/places/) are reproduced below.
