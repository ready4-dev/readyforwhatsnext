...
Currently available (as at  `r format(Sys.Date(),"%d-%b-%Y")`) releases of [module libraries](/docs/software/libraries/types/module/) for [modelling people](/docs/model/using-modules/people/) are reproduced below.
