...
Currently available (as at  `r format(Sys.Date(),"%d-%b-%Y")`) releases of [module libraries](/docs/model/modules/finding/libraries/) for [modelling people](/docs/model/modules/using-modules/people/) are reproduced below.
