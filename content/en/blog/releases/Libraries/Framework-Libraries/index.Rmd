...
Currently available (as at  `r format(Sys.Date(),"%d-%b-%Y")`) releases of [framework libraries](/docs/getting-started/software/libraries/types/framework/) are described below.
